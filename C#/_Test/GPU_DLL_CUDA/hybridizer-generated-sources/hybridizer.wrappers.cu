...
extern "C" DLL_PUBLIC int HybridizerGetShallowSize (const char* fullTypeName) 
{
	...
	if (strcmp (fullTypeName, "GPU_DLL.GPU_DLL+<>c__DisplayClass0_0") == 0) return 24 ; 
	#endif
...
extern "C" DLL_PUBLIC int run_ExternCWrapper_CUDA( int gridDim_x,  int gridDim_y,  int blockDim_x,  int blockDim_y,  int blockDim_z,  int shared,  GPU_DLL::GPU_DLL* const __hybridizer_pself,  int N,  double* const a,  double* const b)
{
	if (0 == __hybridizer_initialized) {                                                            
		cudaDeviceSynchronize();                                                                       
		__hybridizer_initialized = 1;                                                                  
...
extern "C" DLL_PUBLIC int run_ExternCWrapperStream_CUDA( int gridDim_x,  int gridDim_y,  int blockDim_x,  int blockDim_y,  int blockDim_z,  int shared,  cudaStream_t st,  GPU_DLL::GPU_DLL* const __hybridizer_pself,  int N,  double* const a,  double* const b)
{
	if (0 == __hybridizer_initialized) {                                                            
		cudaDeviceSynchronize();                                                                       
		__hybridizer_initialized = 1;                                                                  
...
#if CUDART_VERSION >= 9000
extern "C" DLL_PUBLIC int run_ExternCWrapperGridSync_CUDA( int gridDim_x,  int gridDim_y,  int blockDim_x,  int blockDim_y,  int blockDim_z,  int shared,  GPU_DLL::GPU_DLL* const __hybridizer_pself,  int N,  double* const a,  double* const b)
{
	if (0 == __hybridizer_initialized) {                                                            
		cudaDeviceSynchronize();                                                                       
		__hybridizer_initialized = 1;                                                                  
...
#if CUDART_VERSION >= 9000
extern "C" DLL_PUBLIC int run_ExternCWrapperStreamGridSync_CUDA( int gridDim_x,  int gridDim_y,  int blockDim_x,  int blockDim_y,  int blockDim_z,  int shared,  cudaStream_t st,  GPU_DLL::GPU_DLL* const __hybridizer_pself,  int N,  double* const a,  double* const b)
{
	if (0 == __hybridizer_initialized) {                                                            
		cudaDeviceSynchronize();                                                                       
		__hybridizer_initialized = 1;                                                                  
