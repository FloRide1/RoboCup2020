...
namespace APUData
{
    ...
    public class Landmarks
    {
...

        {
            ...
            Xbounds[0] = Math.Cos((1 * degreesPerScan * CONVERT_DEG_TO_RAD) + (robotPosition[2] * CONVERT_DEG_TO_RAD)) * maxrange + robotPosition[0];
            Ybounds[0] = Math.Sin((1 * degreesPerScan * CONVERT_DEG_TO_RAD) + (robotPosition[2] * CONVERT_DEG_TO_RAD)) * maxrange + robotPosition[1];
            Xbounds[1] = Xbounds[0] + Math.Cos((180 * degreesPerScan * CONVERT_DEG_TO_RAD) + (robotPosition[2] * CONVERT_DEG_TO_RAD)) * maxrange;
            Ybounds[1] = Ybounds[0] + Math.Sin((180 * degreesPerScan * CONVERT_DEG_TO_RAD) + (robotPosition[2] * CONVERT_DEG_TO_RAD)) * maxrange;
            Xbounds[2] = Math.Cos((359 * degreesPerScan * CONVERT_DEG_TO_RAD) + (robotPosition[2] * CONVERT_DEG_TO_RAD)) * maxrange + robotPosition[0];
            Ybounds[2] = Math.Sin((359 * degreesPerScan * CONVERT_DEG_TO_RAD) + (robotPosition[2] * CONVERT_DEG_TO_RAD)) * maxrange + robotPosition[1];
            Xbounds[3] = Xbounds[2] + Math.Cos((180 * degreesPerScan * CONVERT_DEG_TO_RAD) + (robotPosition[2] * CONVERT_DEG_TO_RAD)) * maxrange;
            Ybounds[3] = Ybounds[2] + Math.Sin((180 * degreesPerScan * CONVERT_DEG_TO_RAD) + (robotPosition[2] * CONVERT_DEG_TO_RAD)) * maxrange;
        ...
        */
        ...
        robotPosition)
        {
            ...
            else
            {
                ...
                lm.pos[0] = Math.Cos((readingNo * degreesPerScan * CONVERT_DEG_TO_RAD) + (robotPosition[2] * CONVERT_DEG_TO_RAD)) * distance;
                lm.pos[1] = Math.Sin((readingNo * degreesPerScan * CONVERT_DEG_TO_RAD) + (robotPosition[2] * CONVERT_DEG_TO_RAD)) * distance;
...

        {
            ...
            lm.pos[0] = Math.Cos((readingNo * degreesPerScan * CONVERT_DEG_TO_RAD) + (robotPosition[2] * CONVERT_DEG_TO_RAD)) * range;
            lm.pos[1] = Math.Sin((readingNo * degreesPerScan * CONVERT_DEG_TO_RAD) + (robotPosition[2] * CONVERT_DEG_TO_RAD)) * range;
            lm.pos[0] += robotPosition[0]; //add robot position
            lm.pos[1] += robotPosition[1]; //add robot position
            lm.range = range;
            lm.bearing = readingNo;
