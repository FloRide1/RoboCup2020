...
namespace GPU_DLL { 
struct GPU_DLL___c__DisplayClass0_0 ;
} // Leaving namespace
namespace GPU_DLL { 
struct GPU_DLL ;
} // Leaving namespace
...
{
	if (strcmp (fullTypeName, "GPU_DLL.GPU_DLL") == 0) return 1000000 ; 
	if (strcmp (fullTypeName, "GPU_DLL.GPU_DLL+<>c__DisplayClass0_0") == 0) return 1000001 ; 
...
{
	if (typeId == 1000000) return "GPU_DLL.GPU_DLL" ; 
	if (typeId == 1000001) return "GPU_DLL.GPU_DLL+<>c__DisplayClass0_0" ; 
...
{
	#ifdef __TYPE_DECL__GPU_DLL_GPU_DLL___
	if (strcmp (fullTypeName, "GPU_DLL.GPU_DLL") == 0) return 8 ; 
	#endif
	#ifdef __TYPE_DECL__GPU_DLL_GPU_DLL___c__DisplayClass0_0__
	if (strcmp (fullTypeName, "GPU_DLL.GPU_DLL+<>c__DisplayClass0_0") == 0) return 32 ; 
	#endif
...
extern "C" DLL_PUBLIC int run_ExternCWrapper_CUDA( int gridDim_x,  int gridDim_y,  int blockDim_x,  int blockDim_y,  int blockDim_z,  int shared,  GPU_DLL::GPU_DLL* const __hybridizer_pself,  double* const heatMap,  int width,  int height,  float widthTerrain,  float heightTerrain,  float destinationX,  float destinationY)
{
	if (0 == __hybridizer_initialized) {                                                            
		cudaDeviceSynchronize();                                                                       
		__hybridizer_initialized = 1;                                                                  
	...
	void* __hybridizer_launch_config[10] = 
		{
...
extern "C" DLL_PUBLIC int run_ExternCWrapperStream_CUDA( int gridDim_x,  int gridDim_y,  int blockDim_x,  int blockDim_y,  int blockDim_z,  int shared,  cudaStream_t st,  GPU_DLL::GPU_DLL* const __hybridizer_pself,  double* const heatMap,  int width,  int height,  float widthTerrain,  float heightTerrain,  float destinationX,  float destinationY)
{
	if (0 == __hybridizer_initialized) {                                                            
		cudaDeviceSynchronize();                                                                       
		__hybridizer_initialized = 1;                                                                  
	...
	void* __hybridizer_launch_config[11] = 
		{
			(void*)&__hybridizer_runtime,
			(void*)&__hybridizer_pself,
			(void*)&heatMap,
...
#if CUDART_VERSION >= 9000
extern "C" DLL_PUBLIC int run_ExternCWrapperGridSync_CUDA( int gridDim_x,  int gridDim_y,  int blockDim_x,  int blockDim_y,  int blockDim_z,  int shared,  GPU_DLL::GPU_DLL* const __hybridizer_pself,  double* const heatMap,  int width,  int height,  float widthTerrain,  float heightTerrain,  float destinationX,  float destinationY)
{
	if (0 == __hybridizer_initialized) {                                                            
		cudaDeviceSynchronize();                                                                       
		__hybridizer_initialized = 1;                                                                  
...
#if CUDART_VERSION >= 9000
extern "C" DLL_PUBLIC int run_ExternCWrapperStreamGridSync_CUDA( int gridDim_x,  int gridDim_y,  int blockDim_x,  int blockDim_y,  int blockDim_z,  int shared,  cudaStream_t st,  GPU_DLL::GPU_DLL* const __hybridizer_pself,  double* const heatMap,  int width,  int height,  float widthTerrain,  float heightTerrain,  float destinationX,  float destinationY)
{
	if (0 == __hybridizer_initialized) {                                                            
		cudaDeviceSynchronize();                                                                       
		__hybridizer_initialized = 1;                                                                  
